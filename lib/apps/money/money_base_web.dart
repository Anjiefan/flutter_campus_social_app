...
//class MoneyAppWeb extends StatefulWidget {
//  @override
//  State<StatefulWidget> createState() => MoneyAppState();
//}
//
//class MoneyAppState extends State<MoneyAppWeb> {
//
//  bool ifweb=true;
//  @override
...
//        url: "http://yun.finerit.com/moneybase/",
//        appBar: AppBar(
//          leading: BackButton(
...
class MoneyAppState extends State<MoneyAppIOS> {
  bool iosPayShow;
  ...
  Widget build(BuildContext context) {
    ...
    final List<Widget> choiceChipsA = _materialsA.map<Widget>((String name) {
      return SizedBox(
    ...
    final List<Widget> choiceChipsB = _materialsB.map<Widget>((String name) {
      return SizedBox(
        width: MediaQuery.of(context).size.width * 0.8 / 3,
        child: ChoiceChip(
          key: ValueKey<String>(name),
