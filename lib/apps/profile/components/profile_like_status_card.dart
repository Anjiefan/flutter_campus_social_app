...
import 'package:finerit_app_flutter/apps/profile/components/profile_feedback_story_card.dart';
...
class ProfileLikeBBSCard<T extends Model> extends StatefulWidget{
  int index;
  ProfileLikeBBSCard({
    key
    ,@required this.index
...
class BBSCardState<T extends Model> extends State<ProfileLikeBBSCard>{
                      ...
                      child: new Row(
                        children: <Widget>[
                          UserHead(username: obj.user.nickName
                            ...
                            userInfo: obj.user,),
                          ProfileFeedBackWidgetStatus(index: index,obj: obj,bbsModel: _bbsModel,)
                        ],
